    ...
    <div className="bg-gradient-to-br from-slate-50 via-indigo-50/30 to-purple-50/20">
      <div className="max-w-[1600px] mx-auto p-4 md:p-8 lg:p-10 space-y-5 md:space-y-8 animate-in fade-in duration-700">
          ...
          <div className="relative z-10 space-y-3 md:space-y-4">
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 md:gap-6">
              <div className="space-y-2 md:space-y-3">
                <div className="flex items-center gap-2.5 md:gap-3">
                  <div className="p-2 md:p-2.5 bg-white/20 backdrop-blur-sm rounded-lg md:rounded-xl shadow-lg">
                    <MessagesSquare className="w-5 h-5 md:w-6 md:h-6 text-white" />
                  </div>
                ...
                <div>
                  ...
                  <p className="text-indigo-100 text-sm md:text-lg mt-1 md:mt-2">
              ...
              <Button
                ...
                className="hidden md:flex bg-white text-indigo-700 hover:bg-indigo-50 font-bold shadow-lg gap-2 px-6 h-11"
              >
                <Plus size={18} />
                Nova Dúvida
              </Button>
            ...
            <div className="grid grid-cols-3 gap-2.5 md:gap-4 mt-4 md:mt-6">
              <div className="bg-white/10 backdrop-blur-sm rounded-xl md:rounded-2xl p-3 md:p-4 border border-white/20">
                ...
                <p className="text-white text-xl md:text-2xl font-bold">{topicos.length}</p>
              </div>
              <div className="bg-white/10 backdrop-blur-sm rounded-xl md:rounded-2xl p-3 md:p-4 border border-white/20">
                <p className="text-indigo-100 text-[10px] md:text-xs font-medium mb-0.5 md:mb-1">Resolvidos</p>
                <p className="text-white text-xl md:text-2xl font-bold">{totalResolvidos}</p>
              </div>
              <div className="bg-white/10 backdrop-blur-sm rounded-xl md:rounded-2xl p-3 md:p-4 border border-white/20">
                <p className="text-indigo-100 text-[10px] md:text-xs font-medium mb-0.5 md:mb-1">Em Aberto</p>
                <p className="text-white text-xl md:text-2xl font-bold">{totalAbertos}</p>
              </div>
            </div>
          </div>
        </div>

        {/* Mobile FAB — Nova Dúvida */}
        <div className="md:hidden">
          <Button
            onClick={() => setIsModalOpen(true)}
            className="w-full bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white shadow-lg gap-2 h-11 font-bold text-sm"
          >
            <Plus size={16} />
            Nova Dúvida
          </Button>
        ...
        <section className="space-y-3 md:space-y-4">
          <div className="flex items-center gap-2.5 md:gap-3">
            ...
            <div>
              <h2 className="text-base md:text-xl font-bold text-slate-900">Tópicos</h2>
                ...
                <Card key={i} className="border-0 shadow-lg bg-white/80 overflow-hidden">
                  ...
                  <CardContent className="p-4 md:p-5">
                    <div className="flex gap-3 animate-pulse">
                      <div className="h-9 w-9 md:h-10 md:w-10 rounded-full bg-slate-200 shrink-0" />
                      <div className="flex-1 space-y-2">
                        <div className="h-3.5 md:h-4 w-1/2 bg-slate-200 rounded" />
                ...
                <div className="flex flex-col items-center justify-center text-center max-w-md mx-auto space-y-4 md:space-y-6">
                  <div className="relative">
                    ...
                    <div className="relative p-5 md:p-6 bg-gradient-to-br from-indigo-100 to-purple-100 rounded-2xl md:rounded-3xl">
                      <MessagesSquare className="h-12 w-12 md:h-16 md:w-16 text-indigo-600" />
                    </div>
                  </div>
                  <div className="space-y-2 md:space-y-3">
                    <h3 className="text-xl md:text-2xl font-bold text-slate-900">Nenhuma dúvida postada</h3>
                  ...
                  <Button
                    onClick={() => setIsModalOpen(true)}
                    size="sm"
                    className="bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white shadow-lg gap-2 text-xs md:text-sm"
                  >
                    <Plus size={14} /> Criar primeira dúvida
                  </Button>
                </div>
              </CardContent>
            </Card>
                  ...
                  >
                    ...
                    <CardContent className="p-3.5 md:p-6">
                      <div className="flex items-start gap-3 md:gap-4">
                        {/* Ícone de status */}
                        <div className={cn(
                          "flex-shrink-0 h-10 w-10 md:h-12 md:w-12 rounded-xl md:rounded-2xl flex items-center justify-center shadow-lg transition-all duration-300 group-hover:scale-110",
                          topico.resolvido
                            ? "bg-gradient-to-br from-emerald-500 to-teal-500 text-white"
                            : "bg-gradient-to-br from-amber-500 to-orange-400 text-white"
                        )}>
                          {topico.resolvido
                            ? <CheckCircle2 className="h-5 w-5 md:h-[22px] md:w-[22px]" />
                            : <Clock className="h-5 w-5 md:h-[22px] md:w-[22px]" />
                          }
                        </div>

                        <div className="flex-1 min-w-0 space-y-1.5 md:space-y-2">
                          <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-1.5 md:gap-2">
                            <h3 className="font-bold text-sm md:text-xl text-slate-900 group-hover:text-indigo-700 transition-colors line-clamp-1">
                              {topico.titulo}
                            </h3>
                            <Badge className={cn(
                              "flex-shrink-0 self-start font-bold text-[9px] md:text-[10px] uppercase px-2 md:px-3 h-4 md:h-auto",
                              topico.resolvido
                              ...
                              {topico.resolvido ? 'Resolvido' : 'Aberto'}
                            </Badge>
                          </div>
                          ...
                          {(topico.contexto || topico.tarefa || topico.agendamento) && (
                            <div className="flex flex-wrap gap-1.5 md:gap-2">
                              {topico.contexto && (
                                <span className="text-[9px] md:text-[11px] bg-indigo-50 text-indigo-700 border border-indigo-100 px-2 md:px-2.5 py-0.5 md:py-1 rounded-lg font-medium truncate max-w-[200px]">
                          ...
                          <div className="flex items-center justify-between pt-1.5 md:pt-2 border-t border-slate-100">
                            <div className="flex items-center gap-1.5 md:gap-2 min-w-0">
                              <Avatar className="h-5 w-5 md:h-6 md:w-6 ring-1 ring-slate-200 shrink-0">
                                <AvatarImage src={topico.autor.avatar || ''} />
                                <AvatarFallback className="bg-gradient-to-br from-indigo-400 to-purple-500 text-white text-[8px] md:text-[10px] font-bold">
                                  {topico.autor.nome[0]}
                                </AvatarFallback>
                              </Avatar>
                              <span className="text-[10px] md:text-xs font-semibold text-slate-600 truncate">{topico.autor.nome}</span>
                            ...
                            <span className="flex items-center gap-1 md:gap-1.5 text-[10px] md:text-xs font-semibold text-slate-500 bg-slate-100 px-2 md:px-2.5 py-0.5 md:py-1 rounded-lg shrink-0">
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50 flex items-end md:items-center justify-center bg-black/60 backdrop-blur-sm p-0 md:p-4">
          <div className="bg-white rounded-t-3xl md:rounded-3xl shadow-2xl w-full max-w-lg overflow-hidden animate-in slide-in-from-bottom md:fade-in md:zoom-in duration-200">
            {/* Handle mobile */}
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2.5 md:gap-3">
                  <div className="p-1.5 md:p-2 bg-white/20 rounded-lg md:rounded-xl">
                    <MessagesSquare className="h-4 w-4 md:h-5 md:w-5 text-white" />
                  </div>
                  <h2 className="text-base md:text-xl font-bold text-white">Nova Dúvida</h2>
                </div>
                <button
            ...
            <form onSubmit={handleCreateTopic} className="p-4 md:p-6 space-y-4 md:space-y-5">
              <div className="space-y-1.5 md:space-y-2">
                <Label className="font-semibold text-slate-700 text-sm md:text-base">Título</Label>
                <Input
                  required
                  value={novoTitulo}
                  onChange={(e) => setNovoTitulo(e.target.value)}
                  className="h-10 md:h-11 border-slate-200 focus-visible:ring-indigo-500 text-sm"
                  placeholder="Resumo da sua dúvida..."
                />
              </div>
              <div className="space-y-1.5 md:space-y-2">
                <Label className="font-semibold text-slate-700 text-sm md:text-base">Detalhes</Label>
                <Textarea
                  required
                  rows={4}
                  value={novoConteudo}
                  onChange={(e) => setNovoConteudo(e.target.value)}
                  className="border-slate-200 focus-visible:ring-indigo-500 resize-none text-sm"
                  placeholder="Descreva sua dúvida com detalhes..."
                />
              </div>
              <div className="flex flex-col-reverse sm:flex-row justify-end gap-2 md:gap-3 pt-1 md:pt-2">
                <Button
                  type="button"
                  variant="outline"
                  onClick={() => setIsModalOpen(false)}
                  className="border-slate-200 hover:bg-slate-50 text-sm h-10 md:h-11"
                >
                  Cancelar
                </Button>
                <Button
                  type="submit"
                  disabled={submitting}
                  className="bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white shadow-lg gap-2 text-sm h-10 md:h-11"
                >
                  {submitting
