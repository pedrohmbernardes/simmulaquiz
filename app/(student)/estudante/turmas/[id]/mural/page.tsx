      ...
      <div className="space-y-8 animate-in fade-in duration-700 p-6 md:p-8 lg:p-10 max-w-[1600px] mx-auto">
          ...
          <div className="relative z-10 space-y-4">
            ...
            <div className="grid grid-cols-3 gap-4 mt-6">
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20">
                ...
                <p className="text-white text-2xl font-bold">{totalAvisos}</p>
              </div>
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20">
                <p className="text-indigo-100 text-xs font-medium mb-1">Fixados</p>
                <p className="text-white text-2xl font-bold">{totalFixados}</p>
              </div>
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20">
                <p className="text-indigo-100 text-xs font-medium mb-1">Comentários</p>
                <p className="text-white text-2xl font-bold">{totalComentarios}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <section className="space-y-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl font-bold text-slate-900">Comunicados</h2>
                ...
                <div className="flex flex-col items-center justify-center text-center max-w-md mx-auto space-y-6">
                  <div className="relative">
                    ...
                    <div className="relative p-6 bg-gradient-to-br from-indigo-100 to-purple-100 rounded-3xl">
                      <Megaphone className="h-16 w-16 text-indigo-600" />
                    </div>
                  </div>
                  <div className="space-y-3">
                    ...
                    <p className="text-slate-600 text-base leading-relaxed">
                      Seu professor ainda não publicou nenhum comunicado para esta turma. Fique de olho!
                    </p>
                  </div>
                </div>
              </CardContent>
                ...
                >
                  ...
                  <CardHeader className="pb-3 pt-5 px-6">
                    <div className="flex justify-between items-start gap-4">
                      ...
                      {aviso.fixado && (
                        <Badge className="bg-gradient-to-r from-amber-500 to-orange-500 text-white border-0 gap-1.5 px-3 py-1 shadow-sm flex-shrink-0">
                          <Pin size={11} className="fill-current" /> Fixado
                        </Badge>
                      )}
                    </div>
                  </CardHeader>
                  ...
                  <CardContent className="px-6 pb-5 space-y-4">
                    ...
                    {aviso.anexos.length > 0 && (
                      <div className="space-y-2 pt-2">
                        <h4 className="text-xs font-bold uppercase text-slate-400 tracking-wider flex items-center gap-1.5">
                          <Paperclip size={12} /> Anexos ({aviso.anexos.length})
                        </h4>
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                          {aviso.anexos.map((anexo) => (
                            <a
                              ...
                              className="flex items-center gap-3 p-3 rounded-xl border border-slate-200 bg-slate-50 hover:bg-indigo-50 hover:border-indigo-200 transition-all group"
                            >
                              <div className="h-9 w-9 rounded-lg bg-white border border-slate-200 flex items-center justify-center text-slate-400 group-hover:text-indigo-600 group-hover:border-indigo-200 transition-colors shadow-sm">
                                <FileText size={16} />
                              </div>
                    ...
                    <div className="flex items-center justify-end pt-2 border-t border-slate-100">
                      <Button
                        variant="ghost"
                        size="sm"
                        className="text-slate-400 hover:text-indigo-600 hover:bg-indigo-50 h-8 text-xs gap-1.5 rounded-lg"
                        disabled
                      >
