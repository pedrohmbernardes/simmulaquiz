      ...
      <div className="space-y-5 md:space-y-8 animate-in fade-in duration-700 p-4 md:p-8 lg:p-10 max-w-[1600px] mx-auto">
        ...
        <div className="relative overflow-hidden rounded-2xl md:rounded-3xl bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-600 p-5 md:p-10 shadow-2xl">
          ...
          <div className="relative z-10 flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 md:gap-6">
            ...
            {/* Quick Stats */}
            <div className="flex gap-2.5 md:gap-4 flex-shrink-0">
              <div className="bg-white/15 backdrop-blur-sm border border-white/25 rounded-xl md:rounded-2xl px-4 py-3 md:p-5 text-center shadow-lg min-w-[80px] md:min-w-[100px]">
                <p className="text-2xl md:text-3xl font-bold text-white">{turma.professores.length}</p>
              ...
              <div className="bg-white/15 backdrop-blur-sm border border-white/25 rounded-xl md:rounded-2xl px-4 py-3 md:p-5 text-center shadow-lg min-w-[80px] md:min-w-[100px]">
                <p className="text-2xl md:text-3xl font-bold text-white">{turma.alunos.length}</p>
                <p className="text-white/70 text-[9px] md:text-xs font-bold uppercase tracking-widest mt-0.5 md:mt-1">
        ...
        <section className="space-y-3 md:space-y-4">
          <div className="flex items-center gap-2.5 md:gap-3">
            ...
            <div>
              <h2 className="text-base md:text-xl font-bold text-slate-900">Professores</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-4">
            {turma.professores.map(({ professor }) => (
              <Card
                key={professor.id}
                className="overflow-hidden border-0 shadow-lg bg-white/80 backdrop-blur-sm hover:shadow-xl transition-all duration-300 md:hover:-translate-y-1 group"
              >
                <div className="h-1 md:h-1.5 bg-gradient-to-r from-indigo-500 to-purple-500" />

                <CardContent className="p-4 md:p-5">
                  <div className="flex items-center gap-3 md:gap-4">
                    <Avatar className="h-11 w-11 md:h-14 md:w-14 ring-2 ring-indigo-100 shadow-md flex-shrink-0">
                      <AvatarImage src={professor.fotoUrl || ""} />
                      <AvatarFallback className="bg-gradient-to-br from-indigo-400 to-purple-500 text-white font-bold text-sm md:text-lg">
                        {professor.nome[0]}
                      </AvatarFallback>
                    </Avatar>
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center gap-1.5 md:gap-2 flex-wrap">
                        <p className="font-bold text-slate-900 truncate group-hover:text-indigo-700 transition-colors text-sm md:text-base">
                          {professor.nome}
                        </p>
                        <Badge className="text-[9px] md:text-[10px] bg-indigo-50 text-indigo-700 border border-indigo-200 h-4 md:h-5 px-1 md:px-1.5 flex-shrink-0">
                          PROF
                        </Badge>
                      </div>
                      <p className="text-[10px] md:text-xs text-slate-500 truncate flex items-center gap-1 mt-0.5 md:mt-1">
        ...
        <section className="space-y-3 md:space-y-4">
          <div className="flex items-center gap-2.5 md:gap-3">
            <div className="p-1.5 md:p-2 bg-gradient-to-br from-emerald-500 to-teal-500 rounded-lg md:rounded-xl shadow-lg">
              <UserCheck className="h-4 w-4 md:h-5 md:w-5 text-white" />
            </div>
            <div>
              <h2 className="text-base md:text-xl font-bold text-slate-900">Colegas de Turma</h2>
              <p className="text-xs md:text-sm text-slate-500">
              ...
              {turma.alunos.map(({ aluno }, index) => {
                ...
                return (
                  <div
                    key={aluno.id}
                    className={cn(
                      "p-3 md:p-4 flex items-center gap-3 md:gap-4 transition-colors group",
                  ...
                  >
                    <Avatar
                      className={cn(
                        "h-9 w-9 md:h-11 md:w-11 ring-2 shadow-sm transition-all flex-shrink-0",
                        isMe
                          ? "ring-indigo-300"
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-1.5 md:gap-2 flex-wrap">
                        ...
                        {isMe && (
                          <Badge className="text-[8px] md:text-[10px] bg-indigo-100 text-indigo-700 border border-indigo-200 h-4 md:h-5 px-1 md:px-1.5 flex-shrink-0">
                            Você
                          </Badge>
                        )}
                      </div>
