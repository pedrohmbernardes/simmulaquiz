...
import { apiRateLimit } from "@/lib/ratelimit"; // ✅ NOVO: Importando limitador de API padrão
...
export async function GET(
  ...
  try {
    ...
    // ✅ Rate Limit de Leitura (Evita scraping/sobrecarga da lista de provas)
    const rlKey = `agendamentos_lista:${session.sub}`;
